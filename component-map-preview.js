...
<g id="_x31_0s-s-4">
<rect id="stop" x="183.8" y="149" class="st17" width="3.9" height="45.9" :class="getArtistColorByIndex(4)"/>
...
<g id="_x31_0s-s-6">
<rect id="at" x="183.9" y="260.7" class="st19" width="3.8" height="65.8" :class="getArtistColorByIndex(6)"/>
</g>
<g id="_x31_0s-s-7">
<rect id="is_1_" x="141.3" y="329.4" class="st20" width="3.8" height="15.8" :class="getArtistColorByIndex(7)"/>
<rect id="illustrator" x="141.3" y="381.8" class="st20" width="3.8" height="50" :class="getArtistColorByIndex(7)"/>
</g>
<g id="_x31_0s-s-8">
<rect id="bad_2_" x="141.3" y="431.8" class="st21" width="3.8" height="65.8" :class="getArtistColorByIndex(8)"/>
</g>
<g id="_x31_0s-s-9">
...
<g id="_x31_0s-s-10">
<rect x="148.7" y="350.2" class="st23" width="28.1" height="3.9" :class="getArtistColorByIndex(10)"/>
<rect x="179.5" y="489" class="st23" width="3.9" height="42.5" :class="getArtistColorByIndex(10)"/>
</g>
</g>
<g id="Edges_10">
...
<g id="_x31_0s-m-2not3_1_" v-if="slot02 !== slot03">
...
<g id="_x31_0s-l-1and2_1_" v-if="slot01 === slot02">
...
<g id="show_if_slots_9_1_" class="st33" v-if="slotCount === 9">
...
<g id="show_if_slots_8_1_" class="st33" v-if="slotCount === 8">
...
<g id="show_if_slots_7" class="st33" v-if="slotCount === 7">
