...
<rect x="-37" y="406.2" class="ust8" width="23" height="15.4"/>
    ...
    <g id="show_if_slots_16_1_" class="st3" v-if="slotCount === 16">
    <rect x="51.7" y="131.6" class="st4" width="87.4" height="108.9"/>
    <rect x="96.7" y="161.8" class="st5" width="64.3" height="71.5"/>
    <text transform="matrix(1 0 0 1 96.6717 168.9183)" class="st6 st7 st8">7+ full slots not </text>
    <text transform="matrix(1 0 0 1 96.6717 180.9183)" class="st6 st7 st8">supported!!</text>
    <text transform="matrix(1 0 0 1 96.6717 204.9183)" class="st6 st7 st8">(slots would be </text>
    <text transform="matrix(1 0 0 1 96.6717 216.9183)" class="st6 st7 st8">smaller than </text>
    <text transform="matrix(1 0 0 1 96.6717 228.9183)" class="st6 st7 st8">twelve feet)</text>
    <g class="st6">
    <text transform="matrix(1 0 0 1 96.3279 149.2523)" class="st9 st7 st10">NO PREVIEW!</text>
    </g>
    </g>
    <g id="show_if_slots_15" class="st3" v-if="slotCount === 15">
    <rect x="51.7" y="131.6" class="st4" width="87.4" height="108.9"/>
    <rect x="96.7" y="161.8" class="st5" width="64.3" height="71.5"/>
    <text transform="matrix(1 0 0 1 96.6717 168.9183)" class="st6 st7 st8">7+ full slots not</text>
    <text transform="matrix(1 0 0 1 96.6717 180.9183)" class="st6 st7 st8">supported!!</text>
    ...
    <g id="show_if_slots_14_1_" class="st3" v-if="slotCount === 14">
    <rect x="51.7" y="131.6" class="st4" width="87.4" height="108.9"/>
    <rect x="96.7" y="161.8" class="st5" width="64.3" height="71.5"/>
    <text transform="matrix(1 0 0 1 96.6717 168.9183)" class="st6 st7 st8">7+ full slots not </text>
    <text transform="matrix(1 0 0 1 96.6717 180.9183)" class="st6 st7 st8">supported!!</text>
    ...
    <g id="show_if_slots_13" class="st3" v-if="slotCount === 13">
    <g id="Slots_13" class="st6">
    <g id="_x31_3s-s-1">
    <rect x="135.8" y="356.9" class="st11" width="3.9" height="35.7" :class="getArtistColorByIndex(1)"/>
    <rect x="124.7" y="385.4" transform="matrix(-3.105090e-11 1 -1 -3.105090e-11 521.1827 267.9296)" class="st11" width="3.9" height="18.3" :class="getArtistColorByIndex(1)"/>
    </g>
    <g id="_x31_3s-s-2">
    <rect x="95" y="379.1" transform="matrix(-7.809682e-11 1 -1 -7.809682e-11 491.5364 297.576)" class="st12" width="3.9" height="31" :class="getArtistColorByIndex(2)"/>
    <rect x="47.3" y="369.6" class="st12" width="3.9" height="23" :class="getArtistColorByIndex(2)"/>
    </g>
    <g id="_x31_3s-s-3">
    <rect x="24.6" y="312.9" class="st13" width="3.9" height="54" :class="getArtistColorByIndex(3)"/>
    </g>
    <g id="_x31_3s-s-4">
    <rect x="24.6" y="258.9" class="st14" width="3.9" height="54" :class="getArtistColorByIndex(4)"/>
    </g>
    <g id="_x31_3s-s-5">
    <rect x="24.6" y="204.9" class="st15" width="3.9" height="54" :class="getArtistColorByIndex(5)"/>
    </g>
    <g id="_x31_3s-s-6">
    <rect x="24.6" y="115.3" class="st16" width="3.9" height="54" :class="getArtistColorByIndex(6)"/>
    </g>
    <g id="_x31_3s-s-7">
    <rect x="24.6" y="61.3" class="st17" width="3.9" height="54" :class="getArtistColorByIndex(7)"/>
    </g>
    <g id="_x31_3s-s-8">
    <rect x="91.2" y="8.4" transform="matrix(-2.869812e-11 1 -1 -2.869812e-11 118.824 -67.5259)" class="st18" width="3.9" height="34.5" :class="getArtistColorByIndex(8)"/>
    <rect x="24.6" y="41.8" transform="matrix(-1 -1.599577e-11 1.599577e-11 -1 53.1508 103.1397)" class="st18" width="3.9" height="19.5" :class="getArtistColorByIndex(8)"/>
    </g>
    <g id="_x31_3s-s-9">
    <rect x="167.6" y="41.8" class="st19" width="3.9" height="44.2" :class="getArtistColorByIndex(9)"/>
    <rect x="113.4" y="20.7" transform="matrix(1.138521e-10 -1 1 1.138521e-10 89.6659 140.964)" class="st19" width="3.9" height="9.8" :class="getArtistColorByIndex(9)"/>
    </g>
    <g id="_x31_3s-s-10">
    <rect x="167.6" y="110.8" class="st20" width="3.9" height="32.7" :class="getArtistColorByIndex(10)"/>
    <rect x="167.6" y="86" class="st20" width="3.9" height="21.3" :class="getArtistColorByIndex(10)"/>
    </g>
    <g id="_x31_3s-s-11">
    <rect x="167.6" y="143.5" class="st21" width="3.9" height="54" :class="getArtistColorByIndex(11)"/>
    </g>
    <g id="_x31_3s-s-12">
    <rect x="167.6" y="197.5" class="st22" width="3.9" height="54" :class="getArtistColorByIndex(12)"/>
    </g>
    <g id="_x31_3s-s-13">
    <rect x="167.6" y="251.5" class="st9" width="3.9" height="54" :class="getArtistColorByIndex(13)"/>
    </g>
    </g>
    <g id="Edges_13" class="st6">
    <g id="_x31_3s-e-12not13" v-if="slot12 !== slot13">
    <g>
    <line class="st23" x1="167.6" y1="251.5" x2="166.1" y2="251.5"/>
    <line class="st24" x1="163.7" y1="251.5" x2="155.4" y2="251.5"/>
    <line class="st23" x1="154.2" y1="251.5" x2="152.7" y2="251.5"/>
    </g>
    </g>
    <g id="_x31_3s-e-11not12" v-if="slot11 !== slot12">
    <g>
    <line class="st23" x1="167.6" y1="197.5" x2="166.1" y2="197.5"/>
    <line class="st24" x1="163.7" y1="197.5" x2="155.4" y2="197.5"/>
    <line class="st23" x1="154.2" y1="197.5" x2="152.7" y2="197.5"/>
    </g>
    </g>
    <g id="_x31_3s-e-10not11" v-if="slot10 !== slot11">
    <g>
    <line class="st23" x1="167.6" y1="143.5" x2="166.1" y2="143.5"/>
    <line class="st24" x1="163.7" y1="143.5" x2="155.4" y2="143.5"/>
    <line class="st23" x1="154.2" y1="143.5" x2="152.7" y2="143.5"/>
    </g>
    </g>
    <g id="_x31_3s-e-9not10" v-if="slot09 !== slot10">
    <g>
    <line class="st23" x1="167.6" y1="86" x2="166.1" y2="86"/>
    <line class="st24" x1="163.7" y1="86" x2="155.4" y2="86"/>
    <line class="st23" x1="154.2" y1="86" x2="152.7" y2="86"/>
    </g>
    </g>
    <g id="_x31_3s-e-8not9" v-if="slot08 !== slot09">
    <g>
    <line class="st23" x1="110.4" y1="27.6" x2="110.4" y2="29.1"/>
    <line class="st24" x1="110.4" y1="31.5" x2="110.4" y2="39.8"/>
    <line class="st23" x1="110.4" y1="41" x2="110.4" y2="42.5"/>
    </g>
    </g>
    <g id="_x31_3s-e-7not8" v-if="slot07 !== slot08">
    <g>
    <line class="st23" x1="28.5" y1="61.3" x2="30" y2="61.3"/>
    <line class="st24" x1="32.4" y1="61.3" x2="40.7" y2="61.3"/>
    <line class="st23" x1="41.9" y1="61.3" x2="43.4" y2="61.3"/>
    </g>
    </g>
    <g id="_x31_3s-e-6not7" v-if="slot06 !== slot07">
    <g>
    <line class="st23" x1="28.5" y1="115.3" x2="30" y2="115.3"/>
    <line class="st24" x1="32.4" y1="115.3" x2="40.7" y2="115.3"/>
    <line class="st23" x1="41.9" y1="115.3" x2="43.4" y2="115.3"/>
    </g>
    </g>
    <g id="_x31_3s-e-4not5" v-if="slot04 !== slot05">
    <g>
    <line class="st23" x1="28.5" y1="258.9" x2="30" y2="258.9"/>
    <line class="st24" x1="32.4" y1="258.9" x2="40.7" y2="258.9"/>
    <line class="st23" x1="41.9" y1="258.9" x2="43.4" y2="258.9"/>
    </g>
    </g>
    <g id="_x31_3s-e-3not4" v-if="slot03 !== slot04">
    <g>
    <line class="st23" x1="28.5" y1="312.9" x2="30" y2="312.9"/>
    <line class="st24" x1="32.4" y1="312.9" x2="40.7" y2="312.9"/>
    <line class="st23" x1="41.9" y1="312.9" x2="43.4" y2="312.9"/>
    </g>
    </g>
    <g id="_x31_3s-e-1not2" v-if="slot01 !== slot02">
    <g>
    <line class="st23" x1="115.1" y1="392.6" x2="115.1" y2="391.1"/>
    <line class="st24" x1="115.1" y1="388.7" x2="115.1" y2="380.4"/>
    <line class="st23" x1="115.1" y1="379.2" x2="115.1" y2="377.7"/>
    </g>
    </g>
    </g>
    <g id="Measurements_13" class="st6">
    <g id="_x31_3s-m-12not13" v-if="slot12 !== slot13">
    <text transform="matrix(0 1 -1 0 186.6699 278.5009)" class="st25 st26 st8">75”</text>
    <polyline class="st27" points="173.4,305.5 182.7,278.6 173.4,251.5 "/>
    </g>
    <g id="_x31_3s-m-11not12" v-if="slot11 !== slot12">
    <text transform="matrix(0 1 -1 0 186.6699 154.1663)" class="st25 st26 st8">120”</text>
    <polyline class="st27" points="173.4,197.5 182.7,154.3 173.4,110.8 "/>
    </g>
    <g id="_x31_3s-m-10not11" v-if="slot10 !== slot11">
    <text transform="matrix(0 1 -1 0 186.6699 127.0742)" class="st25 st26 st8">45”</text>
    <polyline class="st27" points="173.4,143.5 182.7,127.2 173.4,110.8 "/>
    </g>
    <g id="_x31_3s-m-9not10" v-if="slot09 !== slot10">
    <text transform="matrix(0 1 -1 0 186.668 96.6555)" class="st25 st26 st8">30”</text>
    <polyline class="st27" points="173.4,107.3 182.7,96.7 173.4,86 "/>
    </g>
    <g id="_x31_3s-m-8not9" v-if="slot08 !== slot09">
    <text transform="matrix(1 0 0 1 115.3146 8.4731)" class="st25 st26 st8">14”</text>
    <polyline class="st27" points="120.2,21.7 115.3,12.4 110.4,21.7 "/>
    </g>
    <g id="_x31_3s-m-7not8" v-if="slot07 !== slot08">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 9.3996 51.5703)" class="st25 st26 st8">27”</text>
    <polyline class="st27" points="22.6,41.8 13.3,51.5 22.6,61.3 "/>
    </g>
    <g id="_x31_3s-m-6not7" v-if="slot06 !== slot07">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 9.3995 142.3389)" class="st25 st26 st8">79”</text>
    <polyline class="st27" points="22.6,115.3 13.3,143.8 22.6,172.5 "/>
    </g>
    <g id="_x31_3s-m-4not5" v-if="slot04 !== slot05">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 9.3994 231.8828)" class="st25 st26 st8">75”</text>
    <polyline class="st27" points="22.6,204.9 13.3,231.8 22.6,258.9 "/>
    </g>
    <g id="_x31_3s-m-3not4" v-if="slot03 !== slot04">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 9.3994 341.2334)" class="st25 st26 st8">79”</text>
    <polyline class="st27" points="22.6,312.9 13.3,341.1 22.6,369.6 "/>
    </g>
    <g id="_x31_3s-m-1not2" v-if="slot01 !== slot02">
    <text transform="matrix(1 0 0 1 125.4336 419.5984)" class="st25 st26 st8">29”</text>
    <polyline class="st27" points="115.1,399.5 125.4,408.8 135.8,399.5 "/>
    </g>
    </g>
    <g id="Label_13" class="st6">
    <g id="_x31_3s-l-1not2-jr" v-if="slot01 !== slot02">
    <text transform="matrix(0 1 -1 0 124.8086 390.5688)" class="st28 st7 st10 jr" :class="getArtistColorByIndex(1)">{{slot01}}</text  >
    </g>
    <g id="_x31_3s-l-2not1-jr" v-if="slot02 !== slot01">
    <text transform="matrix(1 0 0 1 112.3488 387.7216)" class="st28 st7 st10 jr" :class="getArtistColorByIndex(2)">{{slot02}}</text  >
    </g>
    <g id="_x31_3s-l-2not1-jl" v-if="slot02 !== slot01">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 62.6816 391.1221)" class="st28 st7 st10 jl" :class="getArtistColorByIndex(2)">{{slot02}}</text  >
    </g>
    <g id="_x31_3s-l-1and2" v-if="slot01 === slot02">
    <text transform="matrix(1 0 0 1 107.3448 387.7216)" class="st28 st7 st10" :class="getArtistColorByIndex(1)">{{slot01}}</text  >
    </g>
    <g id="_x31_3s-l-3">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 39.0509 341.127)" class="st28 st7 st10" :class="getArtistColorByIndex(3)">{{slot03}}</text  >
    </g>
    <g id="_x31_3s-l-4">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 39.0509 285.8838)" class="st28 st7 st10" :class="getArtistColorByIndex(4)">{{slot04}}</text  >
    </g>
    <g id="_x31_3s-l-5">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 39.0509 230.6406)" class="st28 st7 st10" :class="getArtistColorByIndex(5)">{{slot05}}</text  >
    </g>
    <g id="_x31_3s-l-6">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 39.0508 143.9102)" class="st28 st7 st10" :class="getArtistColorByIndex(6)">{{slot06}}</text  >
    </g>
    <g id="_x31_3s-l-7not8" v-if="slot07 !== slot08">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 39.051 86.8662)" class="st28 st7 st10" :class="getArtistColorByIndex(7)">{{slot07}}</text  >
    </g>
    <g id="_x31_3s-l-7and8" v-if="slot07 === slot08">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 39.051 76.9502)" class="st28 st7 st10" :class="getArtistColorByIndex(7)">{{slot07}}</text  >
    </g>
    <g id="_x31_3s-l-8not7-jl" v-if="slot08 !== slot07">
    <text transform="matrix(1 0 0 1 30.0088 53.3824)" class="st28 st7 st10 jl" :class="getArtistColorByIndex(8)">{{slot08}}</text  >
    </g>
    <g id="_x31_3s-l-8not9-jr" v-if="slot08 !== slot09">
    <text transform="matrix(1 0 0 1 108.2072 38.5626)" class="st28 st7 st10 jr" :class="getArtistColorByIndex(8)">{{slot08}}</text  >
    </g>
    <g id="_x31_3s-l-8and9" v-if="slot08 === slot09">
    <text transform="matrix(1 0 0 1 99.1997 38.5624)" class="st28 st7 st10" :class="getArtistColorByIndex(8)">{{slot08}}</text  >
    </g>
    <g id="_x31_3s-l-9not10-jr" v-if="slot09 !== slot10">
    <text transform="matrix(0 1 -1 0 156.8926 82.195)" class="st28 st7 st10 jr" :class="getArtistColorByIndex(9)">{{slot09}}</text  >
    </g>
    <g id="_x31_3s-l-10not9-jr" v-if="slot10 !== slot09">
    <text transform="matrix(1 0 0 1 163.6621 102.6299)" class="st28 st7 st10 jr" :class="getArtistColorByIndex(10)">{{slot10}}</text  >
    </g>
    <g id="_x31_3s-l-10not11-jr" v-if="slot10 !== slot11">
    <text transform="matrix(1 0 0 1 163.6617 123.647)" class="st28 st7 st10 jr" :class="getArtistColorByIndex(10)">{{slot10}}</text  >
    </g>
    <g id="_x31_3s-l-10and11" v-if="slot10 === slot11">
    <text transform="matrix(0 1 -1 0 156.8926 157.2549)" class="st28 st7 st10" :class="getArtistColorByIndex(10)">{{slot10}}</text  >
    </g>
    <g id="_x31_3s-l-9and10" v-if="slot09 === slot10">
    <text transform="matrix(0 1 -1 0 156.8926 75.1893)" class="st28 st7 st10" :class="getArtistColorByIndex(9)">{{slot09}}</text  >
    </g>
    <g id="_x31_3s-l-11not10" v-if="slot11 !== slot10">
    <text transform="matrix(0 1 -1 0 156.8926 169.2645)" class="st28 st7 st10" :class="getArtistColorByIndex(11)">{{slot11}}</text  >
    </g>
    <g id="_x31_3s-l-12">
    <text transform="matrix(0 1 -1 0 156.8926 224.3085)" class="st28 st7 st10" :class="getArtistColorByIndex(12)">{{slot12}}</text  >
    </g>
    <g id="_x31_3s-l-13">
    <text transform="matrix(0 1 -1 0 156.8926 277.3508)" class="st28 st7 st10" :class="getArtistColorByIndex(13)">{{slot13}}</text  >
    </g>
    </g>
    </g>
    <g id="show_if_slots_12" class="st3" v-if="slotCount === 12">
    <g id="Slots_12" class="st6">
    <g id="_x31_2s-s-1">
    <rect x="135.8" y="346.9" class="st11" width="3.6" height="45.7" :class="getArtistColorByIndex(1)"/>
    <rect x="118" y="378.7" transform="matrix(-5.386821e-11 1 -1 -5.386821e-11 514.4502 274.6621)" class="st11" width="3.9" height="31.8" :class="getArtistColorByIndex(1)"/>
    </g>
    <g id="_x31_2s-s-2">
    <rect x="89.8" y="383.7" transform="matrix(-5.504415e-11 1 -1 -5.504415e-11 486.2493 302.863)" class="st12" width="3.9" height="21.8" :class="getArtistColorByIndex(2)"/>
    <rect x="47.3" y="369.6" class="st12" width="3.9" height="23" :class="getArtistColorByIndex(2)"/>
    <rect x="24.6" y="355.8" class="st12" width="3.9" height="13.8" :class="getArtistColorByIndex(2)"/>
    </g>
    <g id="_x31_2s-s-3">
    <rect x="24.6" y="297.2" class="st13" width="3.9" height="58.6" :class="getArtistColorByIndex(3)"/>
    </g>
    <g id="_x31_2s-s-4">
    <rect x="24.6" y="238.6" class="st14" width="3.9" height="58.6" :class="getArtistColorByIndex(4)"/>
    </g>
    <g id="_x31_2s-s-5">
    <rect x="24.6" y="204.9" class="st15" width="3.9" height="33.7" :class="getArtistColorByIndex(5)"/>
    <rect x="24.6" y="147.6" class="st15" width="3.9" height="24.9" :class="getArtistColorByIndex(5)"/>
    </g>
    <g id="_x31_2s-s-6">
    <rect x="24.6" y="89" class="st16" width="3.9" height="58.6" :class="getArtistColorByIndex(6)"/>
    </g>
    <g id="_x31_2s-s-7">
    <rect x="24.6" y="41.8" class="st17" width="3.9" height="47.2" :class="getArtistColorByIndex(7)"/>
    <rect x="79.7" y="19.9" transform="matrix(3.787021e-11 -1 1 3.787021e-11 56.0131 107.3113)" class="st17" width="3.9" height="11.4" :class="getArtistColorByIndex(7)"/>
    </g>
    <g id="_x31_2s-s-8">
    <rect x="101.9" y="9.2" transform="matrix(-2.728591e-11 1 -1 -2.728591e-11 129.4513 -78.1531)" class="st18" width="3.9" height="32.8" :class="getArtistColorByIndex(8)"/>
    <rect x="167.6" y="41.8" transform="matrix(-1 -2.117074e-11 2.117074e-11 -1 338.9908 109.3707)" class="st18" width="3.9" height="25.8" :class="getArtistColorByIndex(8)"/>
    </g>
    <g id="_x31_2s-s-9">
    <rect x="167.6" y="67.6" class="st19" width="3.9" height="39.8" :class="getArtistColorByIndex(9)"/>
    <rect x="167.6" y="110.8" transform="matrix(-1 -3.055646e-10 3.055646e-10 -1 338.9908 240.5165)" class="st19" width="3.9" height="18.9" :class="getArtistColorByIndex(9)"/>
    </g>
    <g id="_x31_2s-s-10">
    <rect x="167.6" y="129.7" class="st20" width="3.9" height="58.6" :class="getArtistColorByIndex(10)"/>
    </g>
    <g id="_x31_2s-s-11">
    <rect x="167.6" y="188.3" class="st21" width="3.9" height="58.6" :class="getArtistColorByIndex(11)"/>
    </g>
    <g id="_x31_2s-s-12">
    <rect x="167.6" y="246.9" class="st22" width="3.9" height="58.6" :class="getArtistColorByIndex(12)"/>
    </g>
    </g>
    <g id="Edges_12" class="st6">
    <g id="_x31_2s-e-11not12" v-if="slot11 !== slot12">
    <g>
    <line class="st23" x1="167.6" y1="246.9" x2="166.1" y2="246.9"/>
    <line class="st24" x1="163.7" y1="246.9" x2="155.4" y2="246.9"/>
    <line class="st23" x1="154.2" y1="246.9" x2="152.7" y2="246.9"/>
    </g>
    </g>
    <g id="_x31_2s-e-10not11" v-if="slot10 !== slot11">
    <g>
    <line class="st23" x1="167.6" y1="188.3" x2="166.1" y2="188.3"/>
    <line class="st24" x1="163.7" y1="188.3" x2="155.4" y2="188.3"/>
    <line class="st23" x1="154.2" y1="188.3" x2="152.7" y2="188.3"/>
    </g>
    </g>
    <g id="_x31_2s-e-9not10" v-if="slot09 !== slot10">
    <g>
    <line class="st23" x1="167.6" y1="129.7" x2="166.1" y2="129.7"/>
    <line class="st24" x1="163.7" y1="129.7" x2="155.4" y2="129.7"/>
    <line class="st23" x1="154.2" y1="129.7" x2="152.7" y2="129.7"/>
    </g>
    </g>
    <g id="_x31_2s-e-8not9" v-if="slot08 !== slot09">
    <g>
    <line class="st23" x1="167.6" y1="67.6" x2="166.1" y2="67.6"/>
    <line class="st24" x1="163.7" y1="67.6" x2="155.4" y2="67.6"/>
    <line class="st23" x1="154.2" y1="67.6" x2="152.7" y2="67.6"/>
    </g>
    </g>
    <g id="_x31_2s-e-7not8" v-if="slot07 !== slot08">
    <g>
    <line class="st23" x1="87.4" y1="27.6" x2="87.4" y2="29.1"/>
    <line class="st24" x1="87.4" y1="31.5" x2="87.4" y2="39.8"/>
    <line class="st23" x1="87.4" y1="41" x2="87.4" y2="42.5"/>
    </g>
    </g>
    <g id="_x31_2s-e-6not7" v-if="slot06 !== slot07">
    <g>
    <line class="st23" x1="28.5" y1="89" x2="30" y2="89"/>
    <line class="st24" x1="32.4" y1="89" x2="40.7" y2="89"/>
    <line class="st23" x1="41.9" y1="89" x2="43.4" y2="89"/>
    </g>
    </g>
    <g id="_x31_2s-e-5not6" v-if="slot05 !== slot06">
    <g>
    <line class="st23" x1="28.5" y1="147.6" x2="30" y2="147.6"/>
    <line class="st24" x1="32.4" y1="147.6" x2="40.7" y2="147.6"/>
    <line class="st23" x1="41.9" y1="147.6" x2="43.4" y2="147.6"/>
    </g>
    </g>
    <g id="_x31_2s-e-4not5" v-if="slot04 !== slot05">
    <g>
    <line class="st23" x1="28.5" y1="238.6" x2="30" y2="238.6"/>
    <line class="st24" x1="32.4" y1="238.6" x2="40.7" y2="238.6"/>
    <line class="st23" x1="41.9" y1="238.6" x2="43.4" y2="238.6"/>
    </g>
    </g>
    <g id="_x31_2s-e-3not4" v-if="slot03 !== slot04">
    <g>
    <line class="st23" x1="28.5" y1="297.2" x2="30" y2="297.2"/>
    <line class="st24" x1="32.4" y1="297.2" x2="40.7" y2="297.2"/>
    <line class="st23" x1="41.9" y1="297.2" x2="43.4" y2="297.2"/>
    </g>
    </g>
    <g id="_x31_2s-e-2not3" v-if="slot02 !== slot03">
    <g>
    <line class="st23" x1="28.5" y1="355.8" x2="30" y2="355.8"/>
    <line class="st24" x1="32.4" y1="355.8" x2="40.7" y2="355.8"/>
    <line class="st23" x1="41.9" y1="355.8" x2="43.4" y2="355.8"/>
    </g>
    </g>
    <g id="_x31_2s-e-1not2" v-if="slot01 !== slot02">
    <g>
    <line class="st23" x1="103.3" y1="392.6" x2="103.3" y2="391.1"/>
    <line class="st24" x1="103.3" y1="388.7" x2="103.3" y2="380.4"/>
    <line class="st23" x1="103.3" y1="379.2" x2="103.3" y2="377.7"/>
    </g>
    </g>
    </g>
    <g id="Measurements_12" class="st6">
    <g id="_x31_2s-m-11not12" v-if="slot11 !== slot12">
    <text transform="matrix(0 1 -1 0 186.668 276.1984)" class="st25 st26 st8">81”</text>
    <polyline class="st27" points="173.4,305.5 182.7,276.3 173.4,246.9 "/>
    </g>
    <g id="_x31_2s-m-10not11" v-if="slot10 !== slot11">
    <text transform="matrix(0 1 -1 0 186.668 149.5607)" class="st25 st26 st8">108”</text>
    <polyline class="st27" points="173.4,188.3 182.7,149.7 173.4,110.8 "/>
    </g>
    <g id="_x31_2s-m-9not10" v-if="slot09 !== slot10">
    <text transform="matrix(0 1 -1 0 186.6699 120.2582)" class="st25 st26 st8">26”</text>
    <polyline class="st27" points="173.4,129.7 182.7,120.3 173.4,110.8 "/>
    </g>
    <g id="_x31_2s-m-8not9" v-if="slot08 !== slot09">
    <text transform="matrix(0 1 -1 0 186.6699 87.445)" class="st25 st26 st8">55”</text>
    <polyline class="st27" points="173.4,107.3 182.7,87.5 173.4,67.6 "/>
    </g>
    <g id="_x31_2s-m-7not8" v-if="slot07 !== slot08">
    <text transform="matrix(1 0 0 1 81.6624 8.4731)" class="st25 st26 st8">16”</text>
    <polyline class="st27" points="87.4,21.7 81.7,12.4 75.9,21.7 "/>
    </g>
    <g id="_x31_2s-m-6not7" v-if="slot06 !== slot07">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 9.3995 65.3857)" class="st25 st26 st8">66”</text>
    <polyline class="st27" points="22.6,41.8 13.3,65.3 22.6,89 "/>
    </g>
    <g id="_x31_2s-m-5not6" v-if="slot05 !== slot06">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 9.3995 160.0283)" class="st25 st26 st8">35”</text>
    <polyline class="st27" points="22.6,147.6 13.3,160 22.6,172.5 "/>
    </g>
    <g id="_x31_2s-m-4not5" v-if="slot04 !== slot05">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 9.3994 221.7314)" class="st25 st26 st8">47”</text>
    <polyline class="st27" points="22.6,204.9 13.3,221.7 22.6,238.6 "/>
    </g>
    <g id="_x31_2s-m-3not4_1_" v-if="slot03 !== slot04">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 9.3994 333.3838)" class="st25 st26 st8">100”</text>
    <polyline class="st27" points="22.6,297.2 13.3,333.3 22.6,369.6 "/>
    </g>
    <g id="_x31_2s-m-2not3" v-if="slot02 !== slot03">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 9.3994 362.6865)" class="st25 st26 st8">19”</text>
    <polyline class="st27" points="22.6,355.8 13.3,362.7 22.6,369.6 "/>
    </g>
    <g id="_x31_2s-m-1not2" v-if="slot01 !== slot02">
    <text transform="matrix(1 0 0 1 119.894 419.5984)" class="st25 st26 st8">45”</text>
    <polyline class="st27" points="103.3,399.5 119.5,408.8 135.8,399.5 "/>
    </g>
    </g>
    <g id="Label_12" class="st6">
    <g id="_x31_2s-l-1not2-jr" v-if="slot01 !== slot02">
    <text transform="matrix(0 1 -1 0 124.8086 389.568)" class="st28 st7 st10 jr" :class="getArtistColorByIndex(1)">{{slot01}}</text  >
    </g>
    <g id="_x31_2s-l-2not1-jr" v-if="slot02 !== slot01">
    <text transform="matrix(1 0 0 1 100.534 387.7216)" class="st28 st7 st10 jr" :class="getArtistColorByIndex(2)">{{slot02}}</text  >
    </g>
    ...
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 39.0505 331.1211)" class="st28 st7 st10" :class="getArtistColorByIndex(3)">{{slot03}}</text  >
    </g>
    <g id="_x31_2s-l-3not2" v-if="slot03 !== slot02">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 39.0509 326.1162)" class="st28 st7 st10" :class="getArtistColorByIndex(3)">{{slot03}}</text  >
    </g>
    <g id="_x31_2s-l-4">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 40.0517 267.3027)" class="st28 st7 st10" :class="getArtistColorByIndex(4)">{{slot04}}</text  >
    </g>
    <g id="_x31_2s-l-5">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 39.0509 221.6338)" class="st28 st7 st10" :class="getArtistColorByIndex(5)">{{slot05}}</text  >
    </g>
    <g id="_x31_2s-l-5not6-jl" v-if="slot05 !== slot06">
    <text transform="matrix(1 0 0 1 30.407 167.9762)" class="st28 st7 st10 jl" :class="getArtistColorByIndex(5)">{{slot05}}</text  >
    </g>
    <g id="_x31_2s-l-5and6" v-if="slot05 === slot06">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 39.0508 125.8965)" class="st28 st7 st10" :class="getArtistColorByIndex(5)">{{slot05}}</text  >
    </g>
    <g id="_x31_2s-l-6not5" v-if="slot06 !== slot05">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 39.0508 117.8887)" class="st28 st7 st10" :class="getArtistColorByIndex(6)">{{slot06}}</text  >
    </g>
    <g id="_x31_2s-l-7">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 39.051 64.9404)" class="st28 st7 st10" :class="getArtistColorByIndex(7)">{{slot07}}</text  >
    </g>
    <g id="_x31_2s-l-7and8" v-if="slot07 === slot08">
    <text transform="matrix(1 0 0 1 97.5317 37.562)" class="st28 st7 st10" :class="getArtistColorByIndex(7)">{{slot07}}</text  >
    </g>
    <g id="_x31_2s-l-8not7" v-if="slot08 !== slot07">
    <text transform="matrix(1 0 0 1 104.5372 37.5619)" class="st28 st7 st10" :class="getArtistColorByIndex(8)">{{slot08}}</text  >
    </g>
    <g id="_x31_2s-l-8not9-jr" v-if="slot08 !== slot09">
    <text transform="matrix(1 0 0 1 165.0614 53.408)" class="st28 st7 st10 jr" :class="getArtistColorByIndex(8)">{{slot08}}</text  >
    </g>
    <g id="_x31_2s-l-8and9" v-if="slot08 === slot09">
    <text transform="matrix(0 1 -1 0 156.8926 74.1886)" class="st28 st7 st10" :class="getArtistColorByIndex(8)">{{slot08}}</text  >
    </g>
    <g id="_x31_2s-l-9not8" v-if="slot09 !== slot08">
    <text transform="matrix(0 1 -1 0 156.8926 86.198)" class="st28 st7 st10" :class="getArtistColorByIndex(9)">{{slot09}}</text  >
    </g>
    <g id="_x31_2s-l-9not10-jr" v-if="slot09 !== slot10">
    <text transform="matrix(1 0 0 1 163.6617 123.647)" class="st28 st7 st10 jr" :class="getArtistColorByIndex(9)">{{slot09}}</text  >
    </g>
    <g id="_x31_2s-l-9and10" v-if="slot09 === slot10">
    <text transform="matrix(0 1 -1 0 156.8926 149.2485)" class="st28 st7 st10" :class="getArtistColorByIndex(9)">{{slot09}}</text  >
    </g>
    <g id="_x31_2s-l-10not9" v-if="slot10 !== slot09">
    <text transform="matrix(0 1 -1 0 156.8926 157.2549)" class="st28 st7 st10" :class="getArtistColorByIndex(10)">{{slot10}}</text  >
    </g>
    <g id="_x31_2s-l-11">
    <text transform="matrix(0 1 -1 0 156.8926 215.3013)" class="st28 st7 st10" :class="getArtistColorByIndex(11)">{{slot11}}</text  >
    </g>
    <g id="_x31_2s-l-12">
    <text transform="matrix(0 1 -1 0 156.8926 274.1969)" class="st28 st7 st10" :class="getArtistColorByIndex(12)">{{slot12}}</text  >
    </g>
    </g>
    </g>
    <g id="show_if_slots_11" v-if="slotCount === 11">
    <g id="Slots_11">
    <g id="_x31_1s-s-1">
    <rect x="135.8" y="353.7" class="st11" width="3.6" height="39" :class="getArtistColorByIndex(1)"/>
    <rect x="121.4" y="382.1" transform="matrix(-4.234143e-11 1 -1 -4.234143e-11 517.8439 271.2684)" class="st11" width="3.9" height="25" :class="getArtistColorByIndex(1)"/>
    </g>
    <g id="_x31_1s-s-2">
    <rect x="89.2" y="384.2" transform="matrix(-5.198615e-11 1 -1 -5.198615e-11 485.6785 303.4338)" class="st12" width="3.9" height="20.7" :class="getArtistColorByIndex(2)"/>
    <rect x="47.3" y="369.6" class="st12" width="3.9" height="23" :class="getArtistColorByIndex(2)"/>
    <rect x="24.6" y="349.6" class="st12" width="3.9" height="20" :class="getArtistColorByIndex(2)"/>
    </g>
    <g id="_x31_1s-s-3">
    <rect x="24.6" y="285.7" class="st13" width="3.9" height="63.9" :class="getArtistColorByIndex(3)"/>
    </g>
    <g id="_x31_1s-s-4">
    <rect x="24.6" y="221.5" class="st14" width="3.9" height="64.2" :class="getArtistColorByIndex(4)"/>
    </g>
    <g id="_x31_1s-s-5">
    <rect x="24.6" y="204.9" class="st15" width="3.9" height="16.6" :class="getArtistColorByIndex(5)"/>
    <rect x="24.6" y="125.4" class="st15" width="3.9" height="47.1" :class="getArtistColorByIndex(5)"/>
    </g>
    <g id="_x31_1s-s-6">
    <rect x="24.6" y="61.5" class="st16" width="3.9" height="63.9" :class="getArtistColorByIndex(6)"/>
    </g>
    <g id="_x31_1s-s-7">
    <rect x="24.6" y="41.8" class="st17" width="3.9" height="19.7" :class="getArtistColorByIndex(7)"/>
    <rect x="96.1" y="3.5" transform="matrix(1.463079e-10 -1 1 1.463079e-10 72.4331 123.7313)" class="st17" width="3.9" height="44.3" :class="getArtistColorByIndex(7)"/>
    </g>
    <g id="_x31_1s-s-8">
    <rect x="167.6" y="41.8" transform="matrix(-1 -5.269175e-11 5.269175e-11 -1 338.9908 147.5386)" class="st18" width="3.9" height="63.9" :class="getArtistColorByIndex(8)"/>
    </g>
    <g id="_x31_1s-s-9">
    <rect x="167.6" y="112.1" class="st19" width="3.9" height="63.9" :class="getArtistColorByIndex(9)"/>
    </g>
    <g id="_x31_1s-s-10">
    <rect x="167.6" y="176" class="st20" width="3.9" height="63.9" :class="getArtistColorByIndex(10)"/>
    </g>
    <g id="_x31_1s-s-11">
    <rect x="167.6" y="240" class="st21" width="3.9" height="63.9" :class="getArtistColorByIndex(11)"/>
    </g>
    </g>
    <g id="Edges_11">
    <g id="_x31_1s-e-10not11" v-if="slot10 !== slot11">
    <g>
    <line class="st23" x1="167.6" y1="240" x2="166.1" y2="240"/>
    <line class="st24" x1="163.7" y1="240" x2="155.4" y2="240"/>
    <line class="st23" x1="154.2" y1="240" x2="152.7" y2="240"/>
    </g>
    </g>
    <g id="_x31_1s-e-9not10" v-if="slot09 !== slot10">
    <g>
    <line class="st23" x1="167.6" y1="176" x2="166.1" y2="176"/>
    <line class="st24" x1="163.7" y1="176" x2="155.4" y2="176"/>
    <line class="st23" x1="154.2" y1="176" x2="152.7" y2="176"/>
    </g>
    </g>
    <g id="_x31_1s-e-6not7" v-if="slot06 !== slot07">
    <g>
    <line class="st23" x1="28.5" y1="61.5" x2="30" y2="61.5"/>
    <line class="st24" x1="32.4" y1="61.5" x2="40.7" y2="61.5"/>
    <line class="st23" x1="41.9" y1="61.5" x2="43.4" y2="61.5"/>
    </g>
    </g>
    <g id="_x31_1s-e-5not6" v-if="slot05 !== slot06">
    <g>
    <line class="st23" x1="28.5" y1="125.4" x2="30" y2="125.4"/>
    <line class="st24" x1="32.4" y1="125.4" x2="40.7" y2="125.4"/>
    <line class="st23" x1="41.9" y1="125.4" x2="43.4" y2="125.4"/>
    </g>
    </g>
    <g id="_x31_1s-e-4not5" v-if="slot04 !== slot05">
    <g>
    <line class="st23" x1="28.5" y1="221.5" x2="30" y2="221.5"/>
    <line class="st24" x1="32.4" y1="221.5" x2="40.7" y2="221.5"/>
    <line class="st23" x1="41.9" y1="221.5" x2="43.4" y2="221.5"/>
    </g>
    </g>
    <g id="_x31_1s-e-3not4" v-if="slot03 !== slot04">
    <g>
    <line class="st23" x1="28.5" y1="285.7" x2="30" y2="285.7"/>
    <line class="st24" x1="32.4" y1="285.7" x2="40.7" y2="285.7"/>
    <line class="st23" x1="41.9" y1="285.7" x2="43.4" y2="285.7"/>
    </g>
    </g>
    <g id="_x31_1s-e-2not3" v-if="slot02 !== slot03">
    <g>
    <line class="st23" x1="28.5" y1="349.6" x2="30" y2="349.6"/>
    <line class="st24" x1="32.4" y1="349.6" x2="40.7" y2="349.6"/>
    <line class="st23" x1="41.9" y1="349.6" x2="43.4" y2="349.6"/>
    </g>
    </g>
    <g id="_x31_1s-e-1not2" v-if="slot01 !== slot02">
    <g>
    <line class="st23" x1="105.8" y1="392.6" x2="105.8" y2="391.1"/>
    <line class="st24" x1="105.8" y1="388.7" x2="105.8" y2="380.4"/>
    <line class="st23" x1="105.8" y1="379.2" x2="105.8" y2="377.7"/>
    </g>
    </g>
    </g>
    <g id="Measurements_11">
    <g id="_x31_1s-m-10not11" v-if="slot10 !== slot11">
    <text transform="matrix(0 1 -1 0 186.668 272.7418)" class="st25 st26 st8">91”</text>
    <polyline class="st27" points="173.4,305.5 182.7,272.8 173.4,240 "/>
    </g>
    <g id="_x31_1s-m-9not10" v-if="slot09 !== slot10">
    <text transform="matrix(0 1 -1 0 186.6699 143.5403)" class="st25 st26 st8">91”</text>
    <polyline class="st27" points="173.4,176 182.7,143.5 173.4,110.8 "/>
    </g>
    <g id="_x31_1s-m-6not7" v-if="slot06 !== slot07">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 9.3997 52.2998)" class="st25 st26 st8">27”</text>
    <polyline class="st27" points="22.6,41.8 13.3,51.6 22.6,61.5 "/>
    </g>
    <g id="_x31_1s-m-5not6" v-if="slot05 !== slot06">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 9.3995 148.9365)" class="st25 st26 st8">65”</text>
    <polyline class="st27" points="22.6,125.4 13.3,148.9 22.6,172.5 "/>
    </g>
    <g id="_x31_1s-m-4not5" v-if="slot04 !== slot05">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 9.3996 213.7998)" class="st25 st26 st8">23”</text>
    <polyline class="st27" points="22.6,204.9 13.3,213.2 22.6,221.5 "/>
    </g>
    <g id="_x31_1s-m-3not4" v-if="slot03 !== slot04">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 22.6404 285.6572)" class="st25 st26 st8">half-ish</text>
    </g>
    <g id="_x31_1s-m-2not3" v-if="slot02 !== slot03">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 9.3994 362.6865)" class="st25 st26 st8">28”</text>
    <polyline class="st27" points="22.6,349.6 13.3,359.6 22.6,369.6 "/>
    </g>
    <g id="_x31_1s-m-1not2" v-if="slot01 !== slot02">
    <text transform="matrix(1 0 0 1 119.894 419.5984)" class="st25 st26 st8">42”</text>
    <polyline class="st27" points="105.8,399.5 120.8,408.8 135.8,399.5 "/>
    </g>
    </g>
    <g id="Label_11">
    ...
    <text transform="matrix(1 0 0 1 28.6544 364.1004)" class="st28 st7 st10 jl" :class="getArtistColorByIndex(2)">{{slot02}}</text  >
    </g>
    <g id="_x31_1s-l-2and3" v-if="slot02 === slot03">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 39.0504 324.1143)" class="st28 st7 st10" :class="getArtistColorByIndex(2)">{{slot02}}</text  >
    </g>
    <g id="_x31_1s-l-3not2" v-if="slot03 !== slot02">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 39.0505 317.1094)" class="st28 st7 st10" :class="getArtistColorByIndex(3)">{{slot03}}</text  >
    </g>
    <g id="_x31_1s-l-4not5" v-if="slot04 !== slot05">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 40.0517 252.29)" class="st28 st7 st10" :class="getArtistColorByIndex(4)">{{slot04}}</text  >
    </g>
    <g id="_x31_1s-l-4and5" v-if="slot04 === slot05">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 40.0517 246.2842)" class="st28 st7 st10" :class="getArtistColorByIndex(4)">{{slot04}}</text  >
    </g>
    <g id="_x31_1s-l-5not4-jl" v-if="slot05 !== slot04">
    <text transform="matrix(1 0 0 1 30.0436 215.6291)" class="st28 st7 st10 jl" :class="getArtistColorByIndex(5)">{{slot05}}</text  >
    </g>
    <g id="_x31_1s-l-5_1_">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 39.051 148.9131)" class="st28 st7 st10" :class="getArtistColorByIndex(5)">{{slot05}}</text  >
    </g>
    <g id="_x31_1s-l-6and7" v-if="slot06 === slot07">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 39.0508 91.8691)" class="st28 st7 st10" :class="getArtistColorByIndex(6)">{{slot06}}</text  >
    </g>
    <g id="_x31_1s-l-7not6-jl" v-if="slot07 !== slot06">
    <text transform="matrix(1 0 0 1 30.0436 54.9327)" class="st28 st7 st10 jl" :class="getArtistColorByIndex(7)">{{slot07}}</text  >
    </g>
    <g id="_x31_1s-l-7">
    <text transform="matrix(1 0 0 1 97.5317 37.562)" class="st28 st7 st10" :class="getArtistColorByIndex(7)">{{slot07}}</text  >
    </g>
    <g id="_x31_1s-l-8">
    <text transform="matrix(0 1 -1 0 156.8926 72.187)" class="st28 st7 st10" :class="getArtistColorByIndex(8)">{{slot08}}</text  >
    </g>
    <g id="_x31_1s-l-9">
    <text transform="matrix(0 1 -1 0 156.8926 143.2436)" class="st28 st7 st10" :class="getArtistColorByIndex(9)">{{slot09}}</text  >
    </g>
    <g id="_x31_1s-l-10">
    <text transform="matrix(0 1 -1 0 156.8926 208.2957)" class="st28 st7 st10" :class="getArtistColorByIndex(10)">{{slot10}}</text  >
    </g>
    <g id="_x31_1s-l-11">
    <text transform="matrix(0 1 -1 0 156.8926 271.7483)" class="st28 st7 st10" :class="getArtistColorByIndex(11)">{{slot11}}</text  >
    </g>
    </g>
    </g>
    <g id="show_if_slots_6" class="st3" v-if="slotCount === 6">
    <rect x="51.7" y="131.6" class="st4" width="87.4" height="145"/>
    <rect x="96.7" y="161.8" class="st5" width="66.3" height="106"/>
    <text transform="matrix(1 0 0 1 96.6717 168.9183)" class="st6 st7 st8">No template </text>
    <text transform="matrix(1 0 0 1 96.6717 180.9183)" class="st6 st7 st8">available for 3</text>
    <text transform="matrix(1 0 0 1 96.6717 192.9183)" class="st6 st7 st8">full slots!</text>
    <text transform="matrix(1 0 0 1 96.6717 216.9183)" class="st6 st7 st8">Instead, use the </text>
    <text transform="matrix(1 0 0 1 96.6717 228.9183)" class="st6 st7 st8">6 slot template. </text>
    <text transform="matrix(1 0 0 1 96.6717 240.9183)" class="st6 st7 st8">(Double up </text>
    <text transform="matrix(1 0 0 1 96.6717 252.9183)" class="st6 st7 st8">names.)</text>
    <g class="st6">
    <text transform="matrix(1 0 0 1 96.3279 149.2523)" class="st9 st7 st10">NO PREVIEW!</text>
    </g>
    </g>
    <g id="show_if_slots_5" class="st3" v-if="slotCount === 5">
    <rect x="51.7" y="131.6" class="st4" width="87.4" height="145"/>
    <rect x="96.7" y="161.8" class="st5" width="66.3" height="106"/>
    <text transform="matrix(1 0 0 1 96.6717 168.9183)" class="st6 st7 st8">No template </text>
    <text transform="matrix(1 0 0 1 96.6717 180.9183)" class="st6 st7 st8">available for 2.5 </text>
    <text transform="matrix(1 0 0 1 96.6717 192.9183)" class="st6 st7 st8">full slots!</text>
    <text transform="matrix(1 0 0 1 96.6717 216.9183)" class="st6 st7 st8">Instead, use the </text>
    <text transform="matrix(1 0 0 1 96.6717 228.9183)" class="st6 st7 st8">5 slot template. </text>
    <text transform="matrix(1 0 0 1 96.6717 240.9183)" class="st6 st7 st8">(Double up </text>
    <text transform="matrix(1 0 0 1 96.6717 252.9183)" class="st6 st7 st8">names.)</text>
    <g class="st6">
    <text transform="matrix(1 0 0 1 96.3279 149.2523)" class="st9 st7 st10">NO PREVIEW!</text>
    ...
    <g id="show_if_slots_4" class="st3" v-if="slotCount === 4">
    <rect x="51.7" y="131.6" class="st4" width="87.4" height="145"/>
    <rect x="96.7" y="161.8" class="st5" width="66.3" height="106"/>
    <text transform="matrix(1 0 0 1 96.6717 168.9183)" class="st6 st7 st8">No template </text>
    <text transform="matrix(1 0 0 1 96.6717 180.9183)" class="st6 st7 st8">available for 2</text>
    <text transform="matrix(1 0 0 1 96.6717 192.9183)" class="st6 st7 st8">full slots!</text>
    <text transform="matrix(1 0 0 1 96.6717 216.9183)" class="st6 st7 st8">Instead, use the </text>
    <text transform="matrix(1 0 0 1 96.6717 228.9183)" class="st6 st7 st8">4 slot template. </text>
    <text transform="matrix(1 0 0 1 96.6717 240.9183)" class="st6 st7 st8">(Double up </text>
    <text transform="matrix(1 0 0 1 96.6717 252.9183)" class="st6 st7 st8">names.)</text>
    <g class="st6">
    <text transform="matrix(1 0 0 1 96.3279 149.2523)" class="st9 st7 st10">NO PREVIEW!</text>
    ...
    <g id="show_if_slots_3" class="st3" v-if="slotCount === 3">
    <rect x="51.7" y="131.6" class="st4" width="87.4" height="145"/>
    <rect x="96.7" y="161.8" class="st5" width="66.3" height="106"/>
    <text transform="matrix(1 0 0 1 96.6717 168.9183)" class="st6 st7 st8">No template </text>
    <text transform="matrix(1 0 0 1 96.6717 180.9183)" class="st6 st7 st8">available for 1.5 </text>
    <text transform="matrix(1 0 0 1 96.6717 192.9183)" class="st6 st7 st8">full slots!</text>
    <text transform="matrix(1 0 0 1 96.6717 216.9183)" class="st6 st7 st8">Instead, use the </text>
    <text transform="matrix(1 0 0 1 96.6717 228.9183)" class="st6 st7 st8">3 slot template. </text>
    <text transform="matrix(1 0 0 1 96.6717 240.9183)" class="st6 st7 st8">(Double up </text>
    <text transform="matrix(1 0 0 1 96.6717 252.9183)" class="st6 st7 st8">names.)</text>
    <g class="st6">
    <text transform="matrix(1 0 0 1 96.3279 149.2523)" class="st9 st7 st10">NO PREVIEW!</text>
    ...
    <g id="Pallet">
    <rect id="color-01" x="-37" y="21.6" class="st9" width="23" height="15.4"/>
    <rect id="color-02" x="-37" y="36.9" class="st29" width="23" height="15.4"/>
    <rect id="color-03" x="-37" y="52.3" class="st22" width="23" height="15.4"/>
    <rect id="color-04" x="-37" y="67.7" class="st30" width="23" height="15.4"/>
    <rect id="color-05" x="-37" y="83.1" class="st21" width="23" height="15.4"/>
    <rect id="color-06" x="-37" y="98.4" class="st20" width="23" height="15.4"/>
    <rect id="color-07" x="-37" y="113.8" class="st19" width="23" height="15.4"/>
    <rect id="color-08" x="-37" y="129.2" class="st31" width="23" height="15.4"/>
    <rect id="color-09" x="-37" y="144.6" class="st18" width="23" height="15.4"/>
    <rect id="color-10" x="-37" y="159.9" class="st32" width="23" height="15.4"/>
    <rect id="color-11" x="-37" y="175.3" class="st17" width="23" height="15.4"/>
    <rect id="color-12" x="-37" y="190.7" class="st33" width="23" height="15.4"/>
    <rect id="color-13" x="-37" y="206.1" class="st16" width="23" height="15.4"/>
    <rect id="color-14" x="-37" y="221.5" class="st34" width="23" height="15.4"/>
    <rect id="color-15" x="-37" y="236.9" class="st15" width="23" height="15.4"/>
    <rect id="color-16" x="-37" y="252.3" class="st35" width="23" height="15.4"/>
    <rect id="color-17" x="-37" y="267.7" class="st14" width="23" height="15.4"/>
    <rect id="color-18" x="-37" y="283.1" class="st25" width="23" height="15.4"/>
    <rect id="color-19" x="-37" y="298.5" class="st13" width="23" height="15.4"/>
    <rect id="color-20" x="-37" y="313.9" class="st36" width="23" height="15.4"/>
    <rect id="color-21" x="-37" y="329.2" class="st12" width="23" height="15.4"/>
    <rect id="color-22" x="-37" y="344.6" class="st37" width="23" height="15.4"/>
    <rect id="color-23" x="-37" y="360" class="st11" width="23" height="15.4"/>
    <rect x="-37" y="375.4" class="st38" width="23" height="15.4"/>
    <rect x="-37" y="390.8" class="st27" width="23" height="15.4"/>
    <rect x="-37" y="406.2" class="st39" width="23" height="15.4"/>
    </g>
    <g id="_x31_1s-l-6not7_1_" v-if="slot06 !== slot07">
    <text transform="matrix(4.489659e-11 -1 1 4.489659e-11 39.051 82.8604)" class="st28 st7 st10" :class="getArtistColorByIndex(6)">{{slot06}}</text  >
    </g>
    </svg>   
    </div>
</div>
